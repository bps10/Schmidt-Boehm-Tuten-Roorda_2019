...
```{r, fig.height=3, fig.width=4.5, message=FALSE, echo=FALSE}
...
```{r, echo=FALSE, fig.height=3, fig.width=4.5, message=FALSE}
...
```{r, echo=FALSE, fig.height=3, fig.width=11, message=FALSE}
...
library(corrgram)
corrgram(singleConesSummary[ ,c("yb", "gr", "saturation", 
                                "lConeNeighbors", 
                                "distance_to_Scone_1", 
                                "distance_to_Scone_2")], 
...
scatterplotMatrix(twoConesSummary[ , c("yb", "gr", "saturation", 
                                      "lConeNeighbors",
                                      "distance_btwn_cones_arcmin",
                                      "distance_to_Scone_1", "distance_to_Scone_2")],
                  diagonal=list(method ="histogram"),
                  ellipse=FALSE)

corrgram(twoConesSummary[ , c("yb", "gr", "saturation", 
                                      "lConeNeighbors",
                                      "distance_btwn_cones_arcmin",
                                      "distance_to_Scone_1", "distance_to_Scone_2")], 
         order=TRUE, lower.panel=panel.shade,
